        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_bokings_employes_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bokings_guests_guest_id",
                        column: x => x.guest_id,
                        principalTable: "guests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bokings_rooms_room_id",
                        column: x => x.room_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bokings_employee_id",
                table: "bokings",
                column: "employee_id");

            migrationBuilder.CreateIndex(
                name: "IX_bokings_guest_id",
                table: "bokings",
                column: "guest_id");

            migrationBuilder.CreateIndex(
                name: "IX_bokings_room_id",
                table: "bokings",
                column: "room_id");
